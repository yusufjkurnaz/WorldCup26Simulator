...
const CURRENT_VERSION = "v5.0"; // YAYIN SÜRÜMÜ: 5 Slot, Taktikler ve 48 Takım için v5.0 güncellemesi

// --- 1. OYUN İLERLEMESİ (5'Lİ SLOT SİSTEMİ) ---
...
function versiyonKontrol() {
    ...
    if (!kayitliVersiyon || kayitliVersiyon !== CURRENT_VERSION) {
        [1, 2, 3, 4, 5].forEach(id => localStorage.removeItem(`WC26SIM_SLOT_${id}`));
...
// --- 3. YENİ v5.0: OTURUM YÖNETİMİ (SESSION STORAGE - GO LIVE & F5 ÇÖZÜMÜ) ---
